...
SEUILS = {
    ...
    # v11.17 : GOLD.PA (Amundi Physical Gold ETC) ajoutee en CTO, demande
    # explicite. Pas de version PEA : un ETC or physique n est pas eligible
    # PEA (titre de creance adosse a une matiere premiere, pas une action).
    # Seuils : MM200 (achat) / plus haut 1 an +5% (vente).
    "GOLD.PA": {"nom": "Amundi Physical Gold","achat": 155.00,"vente": 190.00,"type": "CTO", "secteur": "Or/Refuge", "quantite": 0, "px_revient": 0},
...
CORRELATIONS = {
    ...
    "GOLD.PA":"Amundi Physical Gold ETC = suit le cours de l or physique (meme sous-jacent que GC=F). Valeur refuge, non correle aux actions. Pas d equivalent PEA (ETC non eligible)",
...
GEO_IMPACT = {
    ...
    "opep":         {"TTE.PA": +15},
    "ormuz":        {"TTE.PA": +25, "GC=F": +10, "GOLD.PA": +10},
    ...
    "accord iran":  {"TTE.PA": -15, "GC=F": -20, "GOLD.PA": -20, "SAF.PA": -10, "HO.PA": -10, "AIR.PA": +10},
    "reouverture ormuz": {"TTE.PA": -20, "GC=F": -15, "GOLD.PA": -15, "AIR.PA": +10, "BNP.PA": +5},
    "negociation iran": {"TTE.PA": -10, "GC=F": -10, "GOLD.PA": -10, "SAF.PA": -5},
    "paix":         {"SAF.PA": -10, "HO.PA": -10, "AM.PA": -10, "TTE.PA": -5},
    "fin guerre":   {"SAF.PA": -15, "HO.PA": -15, "AM.PA": -15, "TTE.PA": -10, "GC=F": -20, "GOLD.PA": -20},
    "rubio":        {"TTE.PA": -10, "GC=F": -10, "GOLD.PA": -10},
    ...
    "or":           {"GC=F": +10, "GOLD.PA": +10},
    "gold":         {"GC=F": +10, "GOLD.PA": +10},
    "crise":        {"ORA.PA": +5, "GC=F": +15, "GOLD.PA": +15},
    "airbus":       {"AIR.PA": +10},
    "boeing":       {"AIR.PA": +5},
