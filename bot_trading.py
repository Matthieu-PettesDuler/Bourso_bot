...
# Les clés sont lues depuis les variables d'environnement Railway
...
Donne une analyse COURTE (max 150 mots) :
...
if __name__ == "__main__":
    ...
    if not TELEGRAM_TOKEN or TELEGRAM_TOKEN == "":
        print("[ERREUR] TELEGRAM_TOKEN manquant dans les variables Railway")
        exit(1)
    if not ANTHROPIC_API_KEY or ANTHROPIC_API_KEY == "":
        print("[ERREUR] ANTHROPIC_API_KEY manquant dans les variables Railway")
        exit(1)

    send_telegram("🚀 <b>Bot Trading demarre sur Railway !</b>\nAnalyses a 9h00 et 17h30.\nValeurs : Orange, Capgemini, Bourso Monde, Bourso Europe.\n24h/24 — peu importe ton ordi.")
